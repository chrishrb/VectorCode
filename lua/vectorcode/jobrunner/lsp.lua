local vectorcode_server_cli_cmd = require("vectorcode.config").get_user_config().cli_cmds.vectorcode_server
local vectorcode_cli_cmd = require("vectorcode.config").get_user_config().cli_cmds.vectorcode
